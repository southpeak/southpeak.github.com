...
【非常感谢 [@lv-pw](http://weibo.com/u/2814972697)，上面这个问题在[《斯坦福大学公开课：iOS 7应用开发》的第5集](http://open.163.com/movie/2014/1/L/H/M9H7S9F1H_M9H801GLH.html)的第57分50秒中得到了解答：确实使用的是unsafe_unretained，老师的解释是，之所以使用unsafe_unretained，而不使用weak，是为了兼容老版本的系统。】
